...
[Source Code 🏆](https://github.com/ilhamshff/ilovepdf)
[Write a feedback 📋](https://t.me/ilhamshffchannel/17?comment=10)"""
...
aboutDev = """Owned By: @ilhamshff
Update Channel: @ilovepdf_bot

Now its easy to create your Own ilhamshff/ilovepdf bot
...
@InHamePDF.on_message(filters.private & ~filters.edited & filters.command(["start"]))
...
@InHamePDF.on_callback_query(strtDevEdt)
...
@InHamePDF.on_callback_query(exploreBot)
...
@InHamePDF.on_callback_query(back)
...
@InHamePDF.on_callback_query(refresh)
...
@InHamePDF.on_callback_query(close)
